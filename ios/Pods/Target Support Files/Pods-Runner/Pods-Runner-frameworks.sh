...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_audio_recorder3/flutter_audio_recorder3.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/photo_gallery/photo_gallery.framework"
