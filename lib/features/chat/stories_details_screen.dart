...
Color(0xff07544E) ,
      ...
      child: Scaffold(
        ...
        body: GridView.builder(gridDelegate:  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3,mainAxisSpacing: 2,crossAxisSpacing: 1,mainAxisExtent: Sizes.screenHeight()*0.3,),padding: const EdgeInsets.symmetric(horizontal: 10), itemBuilder: (context,index){
          return InkWell(
            onTap: (){
              NavigationService.push(
                page: BlocProvider.value(
              ...
              children: [
                if(storiesCubit!.stories.isNotEmpty && storiesCubit?.stories[index] != null)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: storiesCubit?.stories[index].story![0].image != null?Colors.transparent:Colors.white,
                        borderRadius: BorderRadius.circular(15),
                        image: DecorationImage(
